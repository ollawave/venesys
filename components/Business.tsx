            ...
            <SwiperSlide key={index}>
              <div className="relative z-10 h-full flex flex-col justify-center px-6 md:pl-16 md:pr-12 py-6 md:py-20">
                <p
                  ...
                  className={`text-[28px] md:text-[70px] font-normal mb-3 md:mb-16 ${animKey > 0 && activeIndex === index ? "animate-fadeSlideUp" : "opacity-0"}`}
                ...
                {item.category && (
                  <p
                    ...
                    className={`text-[14px] md:text-[20px] text-gray-900 mb-1 md:mb-2 ${animKey > 0 && activeIndex === index ? "animate-fadeSlideUp" : "opacity-0"}`}
                ...
                <h3
                  ...
                  className={`text-[18px] md:text-[30px] font-medium leading-tight whitespace-pre-line text-gray-900 mb-2 md:mb-8 ${animKey > 0 && activeIndex === index ? "animate-fadeSlideUp" : "opacity-0"}`}
                ...
                <p
                  ...
                  className={`text-[12px] md:text-[16px] font-light leading-[1.69] text-gray-600 whitespace-pre-line ${animKey > 0 && activeIndex === index ? "animate-fadeSlideUp" : "opacity-0"}`}
